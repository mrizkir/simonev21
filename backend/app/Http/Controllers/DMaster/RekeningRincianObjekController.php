...
class RekeningRincianObjekController extends Controller {              
    ...
    public function index (Request $request)
    {
        ...
        $objek=RekeningRincianObjekModel::select(\DB::raw('
                                        `tmROby`.`RObyID`,                                        
                                        `tmROby`.`ObyID`,                                        
                                        `tmROby`.`Kd_Rek_5`,
                                        `tmROby`.`RObyNm`,
    ...
    {       
        ...
        $objek = RekeningRincianObjekModel::create([
    ...
    {        
        ...
        $objek = RekeningRincianObjekModel::find($id);
        ...
        else
        {
            ...
            return Response()->json([
                                    ...
                                    'pid'=>'update',
                                    'objek'=>$objek,                                    
                                    'message'=>'Data Rekening Rincian Objek '.$objek->RObyNm.' berhasil diubah.'
                                ],200);
        }
