		...
		foreach ($daftar_program as $data_program)
		{
			...
			if(isset($daftar_kegiatan[0]))
			{
				...
				$data[$row]=[
					...
					'RKAID'=>null,      
					'kode'=>$kode_program,					
					'nama_uraian'=>ucwords(strtoupper($data_program->Nm_Program)),
					'pagu_dana2'=>0,       
					'bobot2'=>0,
					'fisik_target2'=>0,
					'fisik_realisasi2'=>0,
				...
				foreach ($daftar_kegiatan as $data_kegiatan)
				{
					...
					if(isset($daftar_sub_kegiatan[0]))
					{
						...
						$data[$row]=[
							...
							'RKAID'=>null,
							'kode'=>$kode_kegiatan,							
							'nama_uraian'=>ucwords(strtoupper($data_kegiatan->Nm_Kegiatan)),
						...
						foreach ($daftar_sub_kegiatan as $data_sub_kegiatan) 
						{
							...
							$data[$row]=[
								...
								'nama_uraian'=>ucwords(strtoupper($data_sub_kegiatan->Nm_Sub_Kegiatan)),
