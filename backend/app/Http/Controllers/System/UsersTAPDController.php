...
class UsersTAPDController extends Controller {         
    ...
    public function store(Request $request)
    {
        ...
        $user = \DB::transaction(function () use ($request) {
            ...
            \App\Models\System\ActivityLog::log($request,[
                                            ...
                                            'message' => 'Menambah user TAPD('.$user->username.') berhasil'
                                        ]);
    ...
    {
        $this->hasPermissionTo('SYSTEM-USERS-TAPD_SHOW');
    ...
    {
        $this->hasPermissionTo('SYSTEM-USERS-TAPD_UPDATE');
        ...
        else
        {
            ...
            $user = \DB::transaction(function () use ($request,$user) {
                ...
                \App\Models\System\ActivityLog::log($request,[
                                                            ...
                                                            'object_id' => $this->guard()->user()->id, 
                                                            'user_id' => $this->getUserid(), 
                                                            'message' => 'Mengubah data user TAPD ('.$user->username.') berhasil'
                                                        ]);
                return $user;
            });
    ...
    { 
        $this->hasPermissionTo('SYSTEM-USERS-TAPD_DESTROY');
        ...
        else
        {
            ...
            \App\Models\System\ActivityLog::log($request,[
                                                                ...
                                                                'object_id' => $this->guard()->user()->id, 
                                                                'user_id' => $this->getUserid(), 
                                                                'message' => 'Menghapus user TAPD ('.$username.') berhasil'
                                                            ]);
