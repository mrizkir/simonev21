	...
	<div>
		...
		>
			...
			>
				...
				<v-list-item-content>
					<v-list-item-title>BOARD DATA DAK</v-list-item-title>
				</v-list-item-content>
			</v-list-item>
			<v-list-item
				link
				to="/dakmurni/datamentah"
				:active-class="
					$store.getters['uifront/getTheme']('V-LIST-ITEM-BOARD-CSS-CLASS')
				"
				:color="$store.getters['uifront/getTheme']('V-LIST-ITEM-BOARD-COLOR')"
				v-if="CAN_ACCESS('DAK-RKA-MURNI_BROWSE')"
			>
				<v-list-item-icon class="mr-2">
			...
			<v-list-item
				link
				to="/dakmurni/pelaporanopd"
				:active-class="
					$store.getters['uifront/getTheme']('V-LIST-ITEM-BOARD-CSS-CLASS')
				"
				:color="$store.getters['uifront/getTheme']('V-LIST-ITEM-BOARD-COLOR')"
				v-if="CAN_ACCESS('DAK-PELAPORAN-OPD_BROWSE')"
			>
				<v-list-item-icon class="mr-2">
					<v-icon>mdi-arrow-collapse-right</v-icon>
				</v-list-item-icon>
			...
			<v-list-item
				link
				to="/dakmurni/report/forma"
				:active-class="
					$store.getters['uifront/getTheme']('V-LIST-ITEM-BOARD-CSS-CLASS')
				"
				:color="$store.getters['uifront/getTheme']('V-LIST-ITEM-BOARD-COLOR')"
				v-if="CAN_ACCESS('DAK-FORM-A-MURNI_BROWSE')"
			>
				<v-list-item-icon class="mr-2">
					<v-icon>mdi-arrow-collapse-right</v-icon>
				</v-list-item-icon>
			...
			<v-list-item
				link
				to="/dakmurni/report/formbopd"
				:active-class="
					$store.getters['uifront/getTheme']('V-LIST-ITEM-BOARD-CSS-CLASS')
				"
				:color="$store.getters['uifront/getTheme']('V-LIST-ITEM-BOARD-COLOR')"
				v-if="CAN_ACCESS('DAK-FORM-B-MURNI_BROWSE')"
			>
				<v-list-item-icon class="mr-2">
					<v-icon>mdi-arrow-collapse-right</v-icon>
				</v-list-item-icon>
			...
			<v-list-item
				link
				to="/dakmurni/report/formbunitkerja"
				:active-class="
					$store.getters['uifront/getTheme']('V-LIST-ITEM-BOARD-CSS-CLASS')
				"
				:color="$store.getters['uifront/getTheme']('V-LIST-ITEM-BOARD-COLOR')"
			...
			<v-list-item
				link
				to="/dakmurni/statistik/peringkatopd"
				:active-class="
					$store.getters['uifront/getTheme']('V-LIST-ITEM-BOARD-CSS-CLASS')
				"
				:color="$store.getters['uifront/getTheme']('V-LIST-ITEM-BOARD-COLOR')"
				v-if="CAN_ACCESS('DAK-STATISTIK-PERINGKAT-OPD_BROWSE')"
			>
				<v-list-item-icon class="mr-2">
					<v-icon>mdi-arrow-collapse-right</v-icon>
				</v-list-item-icon>
