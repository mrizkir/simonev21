            ...
            <template v-slot:top>
              <v-toolbar flat color="white">
                ...
                <v-tooltip bottom>
                  ...
                  <span>Cetak Daftar Unit Kerja</span>
                </v-tooltip>
                <v-tooltip bottom>
                  <template v-slot:activator="{ on, attrs }">
                    <v-btn
                    ...
                    <v-card>
                      ...
                      <v-card-text>
                        <v-alert type="warning">
                          Menghindari duplikat proses salin, akan menghapus terlebih dahulu data unit kerja T.A {{ $store.getters["auth/TahunSelected"] }}
                        </v-alert>
                        <v-select
  ...
  export default {
    ...
    methods: {
      ...
      printtoexcel: async function() {
        ...
        await this.$ajax
          .post(
            "/dmaster/unitkerja/printtoexcel",
            {
              tahun: this.$store.getters["auth/TahunSelected"],
            },
            {
          ...
          .then(({ data }) => {
            ...
            link.setAttribute(
              "download",
              "daftar_unit_kerja_" + Date.now() + ".xlsx"
            );
