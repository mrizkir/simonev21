  ...
  export default {
    ...
    methods: {
      initialize: async function() {
        ...
        await this.$ajax
          .get("/snapshot/rkamurni/" + this.datakegiatan.RKAID, {
            headers: {
      ...
      exituraianrka() {
        ...
        page.datarekening = {};
        this.$store.dispatch("uiadmin/updatePage", page);
        this.$router.push("/renjamurni/snapshot/rka");
      },
    },
    computed: {
    ...
    watch: {
      RKARincID_Selected: async function(val) {        
        if (val !== null && typeof val !== "undefined") {
          ...
          await this.$ajax
            .post(
              "/snapshot/rkamurni/rencanatarget",
              {
                mode: mode,
