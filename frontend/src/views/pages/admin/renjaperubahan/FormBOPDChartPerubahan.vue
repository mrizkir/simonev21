    ...
    <ModuleHeader>
      ...
      <template v-slot:desc>
        <v-alert color="cyan" border="left" colored-border type="info">
          Laporan Chart Form B OPD Rencana Kegiatan dan Anggaran (RKA) OPD APBD Perubahan
          s.d
          <strong>
  ...
  export default {
    ...
    created() {
      this.breadcrumbs = [
        ...
        },
        {
          text: "FORM B OPD",
          disabled: false,
          href: "/renjaperubahan/report/formbopd",
        },
        {
          text: "CHART",
          disabled: true,
    ...
    methods: {
      ...
      async initialize() {
        await this.$ajax
          .post(
            "/renjaperubahan/report/formbopd/chart",
            {
