    ...
    <ModuleHeader>
      ...
      <template v-slot:desc>
        <v-alert color="cyan" border="left" colored-border type="info">
          Laporan Realisasi Anggaran OPD APBD Perubahan
          s.d
          <strong>
      ...
      <v-row class="mb-4" no-gutters>
        ...
        <v-col cols="12">
          <v-data-table
            ...
            :items="datatable"
            :search="search"
            item-key="FormLRAOPDPerubahanDetailID"
            dense
            :single-expand="true"
            class="elevation-1"
          ...
          >
            ...
            <template v-slot:body="{ items }">
              <tbody>
                <tr
                  v-for="item in items"
                  v-bind:key="item.FormLRAOPDPerubahanDetailID"
  ...
  export default {
    ...
    methods: {
      ...
      printtoexcel: async function() {
        ...
        await this.$ajax
          .post(
            "/renjaperubahan/report/lraopd/printtoexcel",
            {
              tahun: this.$store.getters["auth/TahunSelected"],
              no_bulan: this.bulan_realisasi,
              OrgID: this.OrgID_Selected,
    ...
    watch: {
      OrgID_Selected(val) {
        var page = this.$store.getters["uiadmin/Page"]("lraopdperubahan");
