        ...
        <v-col cols="12">
          ...
          >
            ...
            <template v-slot:no-data>
              <span>TIDAK ADA DATA URAIAN ...</span>
            </template>
          </v-data-table>
        </v-col>
      </v-row>
...
<script>
  ...
  export default {
    name: "SnapshotUraianRKAPerubahan",
    created() {
      this.breadcrumbs = [
        {
          text: "HOME",
        ...
        {
          text: "SNAPSHOT RKA PERUBAHAN",
          disabled: false,
          href: "/renjaperubahan/snapshot/rka",
        },
        {
          text: "URAIAN",
          disabled: true,
    ...
    methods: {
      initialize: async function() {
        ...
        await this.$ajax
          .get("/snapshot/rkaperubahan/" + this.datakegiatan.RKAID, {
            headers: {
      ...
      viewItem(item) {
        ...
        if (page.datauraian.RKARincID == "") {
          ...
          this.$router.push(
            "/renjaperubahan/snapshot/rka/realisasi/" + page.datauraian.RKARincID
          );
        } else {
          this.$root.$confirm
            .open(
      ...
      exituraianrka() {
        ...
        page.datarekening = {};
        this.$store.dispatch("uiadmin/updatePage", page);
        this.$router.push("/renjaperubahan/snapshot/rka");
      },
    },
    computed: {
    ...
    watch: {
      RKARincID_Selected: async function(val) {        
        if (val !== null && typeof val !== "undefined") {
          ...
          await this.$ajax
            .post(
              "/snapshot/rkaperubahan/rencanatarget",
              {
                mode: mode,
