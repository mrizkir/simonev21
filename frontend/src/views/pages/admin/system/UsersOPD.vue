            ...
            <template v-slot:item.active="{ item }">
              <div @click.stop>
                <v-switch
                  ...
                  :disabled="
                    btnLoading ||
                      !$store.getters['auth/can']('SYSTEM-USERS-OPD_UPDATE')
                  "
  ...
  export default {
    ...
    methods: {
      ...
      setUserActive(item, val) {
        ...
        this.$ajax
          .post(
            "/system/usersopd/" + item.id + "/active",
            {
              _method: "PUT",
              active: next,
            },
      ...
      save() {
        if (this.$refs.frmdata.validate()) {
          ...
          if (this.editedIndex > -1) {
            this.$ajax
              .post(
                "/system/usersopd/" + this.editedItem.id,
                {
                  _method: "PUT",
